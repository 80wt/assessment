...
const answers = [
    ...
    '{userName}のいいところは感受性で{userName}のいいところは声です。{userName}の特徴的な声は皆を惹きつけ、心に残ります。す。{userName}が感じたことに皆が共感し、わかりあうことができます。',
...
function assessment(userName){
    ...
    result = result.replace(/\{userName\}/g, userName); // /.../gは正規表現、\はエスケープシーケンス
